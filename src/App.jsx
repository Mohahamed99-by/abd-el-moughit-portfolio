  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        {/* Content */}
        <div className="relative z-10 text-center px-6 max-w-7xl mx-auto py-12 md:py-16 lg:py-20">
          {/* Status Badge */}
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-20 fade-in">
            <a
              href="#portfolio"
          ...
          <div className="mt-16 fade-in">
            <p className="text-gray-400 text-sm mb-6 uppercase tracking-wider">Trusted by</p>
